...
const WhyUs = () => {
  ...
  return (
    <div>
      <div className="why-us-section text-center my-5">
        ...
        <Row>
            ...
            <Card className="h-100 card">
              <Card.Body>
                <div className="icon mb-3">
                  <img src="/image/icon1.png" alt="Patient Centered Icon" />
                </div>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 card">
              <Card.Body>
                <div className="icon mb-3">
                  <img src="/image/icon2.png" alt="AI First Company Icon" />
                </div>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 card">
              <Card.Body>
                <div className="icon mb-3">
                  <img src="/image/icon3.png" alt="Global Focus Icon" />
                </div>
      ...
      <div className="x-image1">
        <img src="/image/x-image.png" alt="X Image" className="overlay" />
      </div>
    ...
    <div className="row" style={{ display: 'flex', flexDirection: 'row-reverse' }}>
        <div className="col-sm-4 provider-feature1 d-flex justify-content-end" style={{ position: 'relative', zIndex: 2 }}>
            <div className="overlay-container">
                <img ref={maleDocRef} src="/image/maledoc1.png" alt="Male Doc 1" className="overlay first" />
                <img ref={maleDocRef} src="/image/maledoc2.png" alt="Male Doc 2" className="overlay second" />
            </div>
        </div>
        <div className="col-sm-8">
            ...
            <p className="provider-text1"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
            <p className="provider-text1"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
            <p className="provider-text1"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
        </div>
    </div>
...
<div className="provider-section-2 my-5"
    ...
    <div className="row">
        <div className="col-sm-4 provider-feature2 d-flex justify-content-end" style={{ position: 'relative', zIndex: 2 }}>
            <div className="overlay-container">
                <img ref={femaleDocRef} src="/image/femaledoc1.png" alt="Female Doc 1" className="overlay first-1" />
                <img ref={femaleDocRef} src="/image/femaledoc2.png" alt="Female Doc 2" className="overlay second-2" />
            </div>
        </div>
        <div className="col-sm-8">
            ...
            <p className="provider-text2"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
            <p className="provider-text2"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
            <p className="provider-text2"><img src="/image/tick.png" alt="Check Icon" /> Lorem ipsum dolor sit amet consectetur.</p>
        </div>
    </div>
          ...
          <Card className="hover-profile-card card-1">
                <Card.Body>
                   <Card.Title className="card-title">
                      <img src="/image/doctor-profile-3.png" alt="Doctor Profile" className="doctor-profile-img" />
                         <span className="profile-name">Dr. Mehmet Akinci</span>
                   </Card.Title>
                        <p className="bar-image-1"><img src="/image/largebar.png" alt="Large Bar" /></p>
                        <p className="bar-image-2"><img src="/image/smallbar.png" alt="Small Bar" /></p>
                </Card.Body>
          </Card>
    <Card className="hover-profile-card card-2">
      <Card.Body>
        <Card.Title className="card-title ">
          <img src="/image/doctor-profile.png" alt="Doctor Profile" className="doctor-profile-img" />
          <span className="profile-name">Dr. Andrew Miller</span>
        </Card.Title>
        <p className="bar-image-1"><img src="/image/largebar.png" alt="Large Bar" /></p>
<p className="bar-image-2"><img src="/image/smallbar.png" alt="Small Bar" /></p>
            <Card.Title className="card-title ">
              <img src="/image/doctor-profile-2.png" alt="Doctor Profile" className="doctor-profile-img" />
...
{femaleHoverData.isVisible && (
        ...
        <Card.Body>
          <Card.Title className="card-title">
            <img src="/image/doctor-profile-4.png" alt="Doctor Profile" className="doctor-profile-img" />
            <span className={`profile-name ${femaleHoverData.doctorType === 'female' ? 'left-align' : ''}`}>Dr. Mamtha</span>
          </Card.Title>
          <p className="bar-image-1"><img src="/image/largebar.png" alt="Large Bar" /></p>
          <p className="bar-image-2"><img src="/image/smallbar.png" alt="Small Bar" /></p>
